...
export function ShimmerAccordion({
  ...
  globalTitleFontSize,
  globalTitleFontWeight = 900,
  globalContentFontSize = '0.9375rem',
  ...
  titleAreaBg = 'transparent',
  titleAreaBgHover = 'transparent',
  contentAreaBg = '#111',
  ...
  const baseTitleSize = globalTitleFontSize || '1.25rem';
    ...
    >
      <style>{`
        .root-${componentId} {
          ...
          --sa-title-font-size: ${typeof baseTitleSize === 'number' ? `${baseTitleSize}px` : baseTitleSize};
        ...
        .root-${componentId} .shimmer-title {
          ...
          line-height: 1.2;
          font-size: var(--sa-title-font-size);
          font-weight: var(--sa-title-font-weight);
        ...
        .root-${componentId} .shimmer-toggle-icon {
          ...
          align-items: center;
          justify-content: center;
          transition: transform 300ms cubic-bezier(0.215, 0.61, 0.355, 1), color 300ms ease;
          opacity: 1;
          color: inherit;
        }
        ...
        .root-${componentId} .shimmer-text {
          ...
          font-size: var(--sa-content-font-size);
          font-weight: var(--sa-content-font-weight);
        }
        ...
        .root-${componentId} .shimmer-title-highlight {
          position: absolute;
          inset: 0;
        ...
        .root-${componentId} .shimmer-button:hover .shimmer-title-highlight {
          transform: scaleX(1);
        }

        .root-${componentId} .shimmer-title-text-wrap {
          position: relative;
          display: inline-flex;
          align-items: center;
        }
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <span className="shimmer-title-text-wrap">
                      <span className="relative z-10 px-1">{item.title}</span>
                      <span 
                        className="shimmer-title-highlight"
                        style={{
                          transformOrigin: itemRTL ? "right" : "left",
                          ...(itemRTL ? { left: '-1px' } : {})
                        }}
                      />
                    </span>
